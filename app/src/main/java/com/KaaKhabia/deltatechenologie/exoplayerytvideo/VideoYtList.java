...
public class VideoYtList {
    ...
    VideoYtList() {
        ...
        videoYt.add(new ItemsList("mKohV9rKI_o", "كرتون كوردج الجبان حلقة هجوم الضفادع", R.drawable.albert_fish_g));
        videoYt.add(new ItemsList("jQ58iNadPQ4", "دار مسكونة: سلسلة من جرائم القتل في دار مسكونة", R.drawable.evil_house_n));
        videoYt.add(new ItemsList("3qkFTKxGBKQ", "القايد مالهرقمة لجبانة", R.drawable.el_geyed_j));
        videoYt.add(new ItemsList("ipgXLRbJRIM", "جزّار روستولف: روسيا", R.drawable.andrei_chikatilo_c));
        videoYt.add(new ItemsList("6Jwvjfrm0ZI", "الحَسناء و الهِبَابْ: سفاحة في الصعيد المصري", R.drawable.said_masr_e));
        videoYt.add(new AdsObject());
        videoYt.add(new ItemsList("l_405U2RKZI", "سْتُوبْ لدنيا لُخْرَا", R.drawable.bernard_giels_d));
